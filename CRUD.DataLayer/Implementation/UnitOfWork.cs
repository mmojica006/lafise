...
namespace CRUD.DataLayer.Implementation
{
    ...
    public class UnitOfWork : IDisposable
    {
        ...
        private DataAccess<TipoEmployee> tipoRepository;
        ...
        public DataAccess<TipoEmployee> GeTipoRepository
        {
            get
            {
                if (this.tipoRepository == null)
                {
                    this.tipoRepository = new DataAccess<TipoEmployee>(this.objMyModel);
                }
